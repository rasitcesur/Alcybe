...
public class SimulationTest2 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		TransferableElementContainer[] inputs2=new TransferableElementContainer[] {new TransferableElementContainer(p3,1), new TransferableElementContainer(p4,1)}; 
		TransferableElementContainer[] outputs2= {new TransferableElementContainer(p5,1,1)}; //, new TransferableElementContainer(p4,1,1)
		...
		p3.addTarget(new TransferInfo(new Process(inputs2, outputs2, new TaskNode(m5,"20"))));
		p4.addTarget(new TransferInfo(new Process(new TaskNode(m3,"20"))));
		p4.addTarget(new TransferInfo(new Process(new TaskNode(m4,"15"))));
		p4.addTarget(new TransferInfo(new Process(inputs2, outputs2, new TaskNode(m5,"20"))));
